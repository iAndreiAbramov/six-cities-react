...
Настоящий проект выполнен в рамках курса "React. Разработка сложных клиентских приложений" от HTML Academy и
переработан спустя полгода коммерческой разработки.
